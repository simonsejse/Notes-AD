...
\sol{}{
  Let us try and calculate the first few terms of the sequence:
  \begin{align*}
    f(1) & = \sum_{i=1}^1 (2i - 1) = 2 \cdot 1 - 1 = 1                                                   \\
    f(2) & = \sum_{i=1}^2 (2i - 1) = (2 \cdot 1 - 1) + (2 \cdot 2 - 1) = 1 + 3 = 4                       \\
    f(3) & = \sum_{i=1}^3 (2i - 1) = (2 \cdot 1 - 1) + (2 \cdot 2 - 1) + (2 \cdot 3 - 1) = 1 + 3 + 5 = 9 \\
    f(4) & = \sum_{i=1}^4 (2i - 1) = (2 \cdot 1 - 1) + \cdots + (2 \cdot 4 - 1) = 1 + 3 + 5 + 7 = 16
  \end{align*}
...
\pf{Proof for Question 6}{
  ...
  \begin{align*}
    \sum_{i=1}^{n+1} f_i^2 & = \text{hey tugge}
  \end{align*}
}
